...
- [SendTicketToWebserviceJobSucceed](../app/Notifications/SendTicketToWebserviceJobSucceed.php) should send if [SendTicketToWebserivce](../app/Jobs/SendTicketToWebservice.php) job succeed
